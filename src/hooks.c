...
/*   Updated: 2022/01/29 22:33:33 by jekim            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int callback_press_move(int code, void *dt)
{
	t_data 		*data;
	t_camera	*cam;
	int			**map_mtrx;
...
void set_hooks(t_data *data)
{
	...
	mlx_hook(data->window->win_ptr, 17, 0, &callback_exit, (void *)data);
